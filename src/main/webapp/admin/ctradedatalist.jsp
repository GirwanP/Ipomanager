...
<spr:admin header1="List Associate">
  ...
  <h1 class="h3 mb-0 text-gray-800">C-Trade Data List </h1>
      ...
      <div class="card-body">
       	...
       	<table class="table table-striped">
					<thead>
						<tr>
							<th scope="col">Id</th>
							<th scope="col">Script Symbol</th>
							<th scope="col">Date</th>
							<th scope="col">Day Max buy price</th>
							<th scope="col">Day Trade target</th>
							<th scope="col">Proceeded</th>
							<th scope="col">Order Succeded</th>
							<th scope="col">Bought</th>
							
							<th scope="col">Last order Price</th>
